    ...
    <form action="" method="POST">
        ...
        <div id="otpSection" class="mb-3" style="display:none;">
            ...
            <div id="otpContainer" style="display:flex; gap:8px;">
                <input type="number" maxlength="1" class="otp-input form-control" inputmode="numeric" pattern="\d*" />
                <input type="number" maxlength="1" class="otp-input form-control" inputmode="numeric" pattern="\d*" />
                <input type="number" maxlength="1" class="otp-input form-control" inputmode="numeric" pattern="\d*" />
                <input type="number" maxlength="1" class="otp-input form-control" inputmode="numeric" pattern="\d*" />
                <input type="number" maxlength="1" class="otp-input form-control" inputmode="numeric" pattern="\d*" />
...
function showFlashMessage(message, type = 'success') {
    ...
    flash.removeClass('alert-success alert-danger alert-warning'); // Remove existing classes
    flash.addClass(type === 'success' ? 'alert-success' : 'alert-danger'); // Add class based on type
    flash.text(message);
    flash.show();
    ...
    document.getElementById('getOtpBtn').addEventListener('click', function() {
        ...
        if (user_name === "" || password === "") {
            ...
            showFlashMessage("User Name and Password cannot be empty", 'error');
            return;
        }
    ...
    document.getElementById('verifyOtpBtn').addEventListener('click', function() {
        ...
        if (otp === "") {
            showFlashMessage("OTP cannot be empty", 'error');
            return;
        }
