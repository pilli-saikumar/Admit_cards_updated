...
while ($template = $templateResult->fetch_assoc()) {
 ...
 //   echo $templateImage; die;
    $template_path = "uttarpradeshpoliceandrecruitmentpromotionboard/templates/68cb975cb7b9d_Admit Card Proforma HCMT_page-0001 (3).jpg";
  //  $pdf->AddPage();
