...
<div class="ml-64 p-1">
    <pre>
         <?php print_r($candidate_sessting_details); ?>
    </pre>
    ...
    <div class="container w-4/5 mx-auto">
                ...
                <div class="card shadow p-3  text-sm       ">
                    ...
                    <form action="" method="post" class="text-sm">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- <select name="login_fields[registration_number][column]"
                                ...
                                <?php foreach ($columns as $col): ?>
                                    <?php if ($col !== 'registration_number' && $col !== 'dob'): ?>
                                        <option value="<?= htmlspecialchars($col) ?> " <?php if ($first_row_column == $col) echo 'selected'; ?>>
                            ...
                            <option value="registration_number" <?= ($first_row_column == 'registration_number') ? 'selected' : '' ?>>
                                Registration Number (Default)
                            </option>

                            <?php foreach ($columns as $col): ?>
                                <?php if ($col !== 'registration_number' && $col !== 'dob'): ?>
                                    <option value="<?= htmlspecialchars($col) ?>" <?= ($first_row_column == $col) ? 'selected' : '' ?>>
                                        <?= htmlspecialchars(ucwords(str_replace('_', ' ', $col))) ?>
                                    </option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                value="<?= (!empty($first_row_label)) ? $first_row_label : 'Registration Number' ?>">
                        </div>
                        ...
                        <option value="dob" <?= ($second_row_column == 'dob') ? 'selected' : '' ?>>
                            Date of Birth (Default)
                        </option>

                        <?php foreach ($columns as $col): ?>
                            <?php if ($col !== 'registration_number' && $col !== 'dob'): ?>
                                <option value="<?= htmlspecialchars($col) ?>" <?= ($second_row_column == $col) ? 'selected' : '' ?>>
                                    <?= htmlspecialchars(ucwords(str_replace('_', ' ', $col))) ?>
                                </option>
                            <?php endif; ?>
                        <?php endforeach; ?>
       ...
       id="dob_label"
       value="<?= (!empty($second_row_label)) ? $second_row_label : 'Date of Birth' ?>">
