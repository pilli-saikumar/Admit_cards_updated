...
if (isset($_GET['batch']) && $_GET['batch'] <= $total_batches) {
    processBatch($conn, $project_id, $filter_column, $offset, $records_per_batch,$column_based, $current_batch);
    exit();
}
...
function processBatch($conn, $project_id, $filter_column, $offset, $records_per_batch,$column_based, $current_batch) {
    // Fetch templates
    if ($filter_column === 'all') {
