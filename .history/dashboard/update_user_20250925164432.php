...
$backupSql = "
    INSERT INTO admitcard_edit_data (
        admitcard_record_id,
        " . implode(",", array_map(function($c){ return $c['Field']; }, $conn->query("SHOW COLUMNS FROM admit_card_records")->fetch_all(MYSQLI_ASSOC))) . "
    )
    SELECT
        id, *  -- id goes to admitcard_record_id, rest of columns as is
