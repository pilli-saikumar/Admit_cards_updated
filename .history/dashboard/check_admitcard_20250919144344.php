            ...
            <?php endwhile; ?>
              ...
              $path_url = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://{$_SERVER['HTTP_HOST']}";
                ...
                <div class="text-center mt-3">
                    ...
                    <?php }else{
                        ?>
                        <button onclick="alert('Candidate settings not found! Please set the candidate settings before generating the URL.')" style="color: red;" class="btn btn-warning btn-sm">
                        Generate Admit Card URL
                    </button>
                    <?php } ?>
