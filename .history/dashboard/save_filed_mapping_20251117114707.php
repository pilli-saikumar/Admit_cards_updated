   ...
   $stmt->bind_param(
    ...
    logUserAction($conn, $_SESSION['user_name'], $_SESSION['user_role'], $project_id, $template_id, $action);
                ...
                $createdAt = date('Y-m-d H:i:s');
                    ...
                    VALUES (?, ?, ?, ?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)");
                $stmt->bind_param("iissiiissssssiss", $project_id, $template_id, $column_filter, $column_name,$c $x, $y, $w, $h, $cell, $font_size, $font_type, $font_color, $font_style, $line_break,$createdAt,$_SESSION['user_name']);
