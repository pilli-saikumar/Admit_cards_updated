  ...
  <?php if (isset($_SESSION['flash_error'])) {
   ...
   <div class="text-center mb-1">
    ...
    <div class="mb-4">
        ...
        <input type="file" name="csv_file" multiple class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" accept=".xlsx" required>
