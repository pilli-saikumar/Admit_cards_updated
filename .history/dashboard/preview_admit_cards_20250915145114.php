...
// echo "<pre/>"; print_r($value . " width:" .$width ."height". $height ."");
        ...
        if ($pageNumber === 1 && !empty($registrationNumber)) {
            ...
            $pdf $barcodeimage = "https://admitcards.iroams.com/Admitcards/dashboard/b/barcode.php?size=30&print=false&text=" . $registrationNumber;->Image($barcodeimage,$x, $y, $width, $height, 'PNG');
