   ...
   //   $created_by = $_SESSION['user_name'];
    ...
    if (empty($errors)) {
        ...
        if (empty($errors)) { // Check errors again after directory creation
            ...
            if (!copy(__DIR__ . '/../Candidate/preview_admit_cards.php', "$basePath/preview_admit_cards.php")) {
                $errors[] = 'Failed to copy preview_admit_cards.php file.';
            }
            if (!copy(__DIR__ . '/../Candidate/generate_pdf.php', "$basePath/generate_pdf.php")) {
                $errors[] = 'Failed to copy generate_pdf.php file.';
            }
        }
        }
