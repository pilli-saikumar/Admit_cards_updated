                ...
                <div class="card shadow p-3  text-sm       ">
                    ...
                    <form action="" method="post" class="text-sm">
                        ...
                        <!-- <div class="mb-3">
                            ...
                            <select name="login_fields[registration_number]" id="registration_number" class="form-select text-sm" onchange="updateLoginLabel()">
                        ...
                        <div class="mb-3">
                            <label id="loginLabel" class="form-label text-sm">Registration Number</label>
                            <input type="text" class="form-control text-sm" id="loginLabel">
                        </div>

                     
                        <div class="mb-3">
                            <label for="dob" class="form-label text-sm">DOB Field</label>
                            <select name="login_fields[dob]" id="dob" class="form-select text-sm" onchange="updateLoginLabel()">
                        ...
                        <div class="mb-3">
                            <label id="loginLabels" class="form-label text-sm">Date of Birth</label>
