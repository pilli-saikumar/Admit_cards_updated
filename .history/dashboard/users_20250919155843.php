...
<div class="mb-3" style="display:flex; gap:10px; align-items:center;">
  <a href="export_users.php?project_id=<?= $project_id ?>" class="btn btn-success btn-sm">Export All (CSV)</a>
  <span class="text-muted" style="font-size:12px;">Exports all records and all fields for this project</span>
</div>
