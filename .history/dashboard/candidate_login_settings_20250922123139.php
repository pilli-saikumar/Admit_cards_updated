            ...
            <div class="">
                <div class="card shadow p-3  text-sm       ">
                    ...
                    <form action="" method="post" class="text-sm">
                        ...
                        <?php echo "<pre>"; print_r($columns); echo "</pre>"; ?>
                        <div class="mb-3">
                        <label for="registration_number" class="form-label">Login With</label>
                            <select name="login_fields[registration_number][column]"
                                id="registration_number"
                                ...
                                <?php foreach ($columns as $col): ?>
                                            <?php if($col == $first_row_column){

                                                echo "<option value=\"" . htmlspecialchars($col) . "\" selected>" . htmlspecialchars(ucwords(str_replace('_', ' ', $col))) . "</option>";
                                                
                                            }else{
                                                echo "<option value=\"" . htmlspecialchars($col) . "\" >" . htmlspecialchars(ucwords(str_replace('_', ' ', $col))) . "</option>";
                                            }
                                            ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                value="<?= (empty($first_row_label)) ? 'Registration Number' : $first_row_label ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                id="dob_label"
                                value="<?= (empty($second_row_label)) ? 'Date of Birth' : $second_row_label ?>">
                        </div>
