                    ...
                    <form action="" method="post" class="text-sm">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="login_fields[registration_number][column]"
                                ...
                                <option value="registration_number" <?php if ($first_row_column == 'registration_number') echo 'selected'; ?> selected>Registration Number (Default)</option>
