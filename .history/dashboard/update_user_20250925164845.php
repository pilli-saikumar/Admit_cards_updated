...
// Prepare SQL
$backupSql = "INSERT INTO admitcard_edit_data ($insertColumns) SELECT $selectColumns FROM admit_card_records WHERE SELECT * FROM admit_cards_data.admitcard_edit_data; = ?";
