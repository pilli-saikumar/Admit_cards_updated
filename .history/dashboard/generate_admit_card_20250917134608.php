    ...
    <?php if (!empty($uploaded_templates)) { ?>
        ...
        <form method="POST" action="save_filed_mapping.php">
            ...
            <?php  foreach ($uploaded_templates as $template):
                ...
                $template_path = "uttarpradeshpoliceandrecruitmentpromotionboard\templates\all_1_68c8f90050213_ADMITCARDFORHCMT-176POST_page-0001.jpg";
                    ...
                    <div style="display: flex; justify-content: center;">
                        <div style="position: relative; display: inline-block; border: 1px solid black;">
                            <img class="templateImage" 
                                 src="<?= "uttarpradeshpoliceandrecruitmentpromotionboard\templates\all_1_68c8f90050213_ADMITCARDFORHCMT-176POST_page-0001.jpg" ?>" 
                                 data-template-id="<?= $template_id ?>" 
