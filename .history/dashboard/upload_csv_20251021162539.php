...
if ($result) {
    $allowed_columns = ['registration_number','roll_number','first_name', 'last_name', 'dob', 'sex', 'photo_path', 'signature_path','post_applied','community','nameofposition','candi_type','domicial','degree_university','inter_university','position_codes',''];
