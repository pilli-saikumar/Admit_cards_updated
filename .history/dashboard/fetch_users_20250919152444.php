...
if (!empty($searchValue)) {
    $where .= " AND (registration_number LIKE ? OR first_name LIKE ? OR emailaddress LIKE ? OR mobileNumber LIKE ? OR roll_number LIKE ? )";
...
// Get filtered data
$query = "SELECT id, registration_number, first_name, emailaddress, mobileNumber FROM admit_card_records $where LIMIT ?, ?";
$params[] = $start;
$params[] = $length;
$types .= "ii";
