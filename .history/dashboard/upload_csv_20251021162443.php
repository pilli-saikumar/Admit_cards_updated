...
if ($result) {
    $allowed_columns = ['registration_number','roll_number','first_name', 'last_name', 'dob', 'sex', 'photo_path', 'signature_path','post_applied','community','nameofposition','candi_type','domicial','degree_university','degree_year','degree_percentage','degree_branch','inter_university','inter_year','inter_percentage','inter_branch','highschool_university','highschool_year','highschool_percentage','highschool_branch',''];
