...
<div class="ml-64 p-3">
   <!-- <a href="javascript:history.back()" class="back-button">← Back</a> -->
    ...
    <!-- <select name="barcode_based[<?= $template_id ?>][]" class="form-control">
        <option value="registration_number">Registration Number</option>
        <option value="roll_number">Roll Number</option>
    </select> -->
    <select name="template_barcode_source[<?= $template_id ?>]" class="form-control">
        <option value="">No Barcode</option>
        <option value="registration_number" 
            <?= (isset($current_barcode_setting) && $current_barcode_setting == 'registration_number') ? 'selected' : '' ?>>
            Registration Number
        </option>
        <option value="roll_number"
            <?= (isset($current_barcode_setting) && $current_barcode_setting == 'roll_number') ? 'selected' : '' ?>>
            Roll Number
        </option>
        </select>
</div>
