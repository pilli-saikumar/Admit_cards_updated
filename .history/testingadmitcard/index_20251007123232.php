...
<body>
    ...
    <div class="login-card">
        ...
        <small class="text-center" style="text-align: center;"><?php echo htmlspecialchars($sub_header); ?></small>
   ...
   <div class="mb-3">
    ...
    <div class="login-card">
        ...
        <img src="/Admit_Cards/<?= htmlspecialchars($project_logo) ?>" alt="" class="brand-logo rounded-circle">
        <p class="text-center"><?php echo nl2br(htmlspecialchars($project_header)); ?></p>
        <small class="text-center"><?php echo nl2br(htmlspecialchars($sub_header)); ?></small>
