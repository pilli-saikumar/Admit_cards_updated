...
if (!empty($slug)) {
    ...
    // ");
    $stmt = $conn->prepare("
        SELECT id, logo_path, header, name, project_live_date, project_end_date,sub_header,forgot_label_name
        FROM projects
...
<body>
    ...
    <div class="login-card">
      <?php ?>
        ...
        <p class=""><?php echo nl2br(htmlspecialchars($project_header)); ?></p>
            <!-- <h3 style=""><?=  nl2br(htmlspecialchars($project_header))  ?></h3> -->
        <!-- <h3 style="font-size: 1.5rem;"><?=  nl2br(htmlspecialchars($project_header))  ?><br> <small style="font-size: 13px; color: #666; "><?= nl2br(htmlspecialchars($sub_header))  ?></small>  </h3> -->
