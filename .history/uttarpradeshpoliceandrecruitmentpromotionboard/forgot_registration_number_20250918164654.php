        ...
        foreach ($forgot_settings as $setting) {
            ...
            if (isset($_POST[$column])) {
                ...
                if ($column === 'first_name') {
                    // Ignore spaces and case for first_name comparisons
                    $whereClause[] = "REPLACE(UPPER($column), ' ', '') = REPLACE(UPPER(?), ' ', '')";
                } else {
                    $whereClause[] = "$column = ?";
                }
                $paramTypes .= 's';
...
<body>
    ...
    <div class="login-card">  
        ...
        <?php if(isset($forgot_label_name)) : ?>
        ...
        <?php if($userData){ ?>
            ...
            <?php
                        ...
                        foreach ($forgot_view_details as $view_detail) {
                            ...
                            $view_status = $view_detail['view_status'];
                            
                            if (isset($userData[$column_name]) && !empty($userData[$column_name]) && $view_status == 1) {
