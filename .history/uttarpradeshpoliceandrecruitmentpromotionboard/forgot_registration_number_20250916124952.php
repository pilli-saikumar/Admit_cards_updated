...
<body>
   ...
   <?php
   // Display all fields from forgot_view_details
   foreach ($forgot_view_details as $view_detail) {
       $column_name = $view_detail['column_name'];
       $label_name = $view_detail['label_name'];
       
       if (isset($userData[$column_name]) && !empty($userData[$column_name])) {
           echo htmlspecialchars($label_name) . ": " . htmlspecialchars($userData[$column_name]) . "<br>";
       }
   }
   ?>
  <br>
