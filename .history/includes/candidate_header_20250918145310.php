...
// Persist slug for later redirects (helps logout when session is destroyed)
setcookie('last_project_slug', $slug, time() + 86400, '/Admit_Cards', '', false, true);
...
<header class="bg-white border-b shadow-md px-6 py-3 flex items-center justify-between fixed top-0 left-0 right-0 z-50 h-16">
  ...
  <a href="../logout.php?project=<?= urlencode($slug) ?>"
