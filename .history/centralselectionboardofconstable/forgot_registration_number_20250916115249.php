...
// Always generate a new captcha for each page load to ensure consistency
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "SELECT id, registration_number,first_name,last_name,roll_number FROM admit_card_records WHERE $whereClauseStr AND project_id = $project_id";
...
<body>
    ...
    <input type="text" 
         ...
         <?php if($userData){ ?>
         <div class="alert alert-success text-center mt-2">Registration Number: <?= $userData['reroll_numbergistration_number'] ?>
        <br>
