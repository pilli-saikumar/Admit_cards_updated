...
echo "<pre/>"; print_r( $recordsResult->fetch_all(MYSQLI_ASSOC) );exit;
      ...
      <div class="col-6 mb-4">
                      ...
                      <div class="table-responsive">
                          <table class="table table-striped table-hover mb-0">
                              <tbody>
                                  ...
                                  ?>
                                      <tr>
                                          <td class="fw-semibold text-muted text-left" style="width: 40%;">
                                              <?= $label ?>
                                          </td>
                                          <td class="fw-bold text-dark text-left">
                                              <?= $value ?> 
                                          </td>
                                      </tr>
                                  <?php endforeach; ?>
          ...
          <div class="card-body text-center">
              ...
              <?php foreach ($records as $record): ?>
                      <h6 style="color:black; font-family: 'Arial Black', sans-serif;  font-size: 15px; margin-top: 1rem;">
