...
<div class="login-container">
    ...
    <form action="" method="POST">
        ...
        <div id="otpSection" class="mb-3" style="display:none;">
            ...
            <input type="text" id="otp" class="form-control" placeholder="6-digit OTP" maxlength="6" inputmode="numeric" pattern="\d{6}">
...
<script>
    document.getElementById('getOtpBtn').addEventListener('click', function() {
        let user_name = document.getElementById('user_name').trim().value;
        let password = document.getElementById('password').trim().value;
