...
<!-- <header class="bg-white border-b shadow-md px-6 py-3 flex flex-wrap items-center top-0 left-0 right-0 z-50">
  <div class="flex flex-wrap items-center justify-center space-x-4">
    ...
    <h1 class="text-xl font-semibold text-gray-800 tracking-wide"><?= nl2br(htmlspecialchars($project_header)) ?></h1>
  </div>
 
</header> -->
<header class="bg-white border-b shadow-md px-6 py-3 fixed top-0 left-0 right-0 z-50 flex items-start">
  <div class="flex items-start gap-4 w-full">
    <!-- Logo -->
    <img src="/Admit_Cards/<?= htmlspecialchars($project_logo) ?>" 
         alt="Project Logo" 
         class="logo h-12 w-auto object-contain flex-shrink-0" />
    
    <!-- Project Header -->
    <h1 class="text-xl sm:text-2xl font-semibold text-gray-800 tracking-wide break-words">
      <?= nl2br(htmlspecialchars($project_header)) ?>
    </h1>
  </div>
</header>
</div>
