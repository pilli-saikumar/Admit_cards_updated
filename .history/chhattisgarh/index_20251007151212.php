...
<body>
    ...
    <div class="login-card">
        ...
        <P class="text-center"><?=  nl2br(htmlspecialchars($project_header))  ?></P>
     <p class="" style="text-align: center; font-size: 13px; color: #666; "><?php echo htmlspecialchars($sub_header); ?></p>                                                                                                                                                                                                     "><?=  htmlspecialchars($sub_header)  ?></P>
