...
if (!empty($slug)) {
    ...
    $stmt = $conn->prepare("
        ...
        FROM projects
        WHERE slug = ? AND is_delete = 0  AND live_url = 0");
...
<body>
    ...
    <div class="login-card">
      <?php if(isset($live_url) && $live_url ==0){ ?>
        <div style='text-align:center; margin-top:50px; color:red; font-weight:bold;'>
            Admit card will be available soon. Please check later.
          </div>
      <?php }else{ ?>
